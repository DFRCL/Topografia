...
#archivoinput = askopenfilename(filetypes=[('GPX','.gpx'),('All files','.*')], defaultextension='.gpx')
#datos = parse_gpx(archivoinput, formato='UTM')


#Plot_gpx_to_dxf(asksaveasfilename(filetypes=[('DXF','.dxf'),('All files','.*')], defaultextension='.dxf'))
...
#guardar_csv(asksaveasfilename(defaultextension='.csv',filetypes=[('CSV','.csv'),('All files','.*')]), generar_libreta_totales(Z=False), ['X','Y','Z'])
#guardar_csv(asksaveasfilename(defaultextension='.csv',filetypes=[('CSV','.csv'),('All files','.*')]), generar_salida_geograficas(archivoinput), Libreta.keys())